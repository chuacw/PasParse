...
{$ELSE}
  published
    procedure TestPropertyDirective;
{$ENDIF}
  end;
...
procedure TTestPropertyDirective.TestPropertyDirective;
begin
  OK('; default', TTestParser.ParsesAs('; default',
    'DirectiveNode' + #13#10 +
    '  SemicolonNode: Semicolon |;|' + #13#10 +
    '  KeywordNode: DefaultSemikeyword |default|' + #13#10 +
    '  ValueNode: (none)' + #13#10 +
    '  DataNode: (none)', RTPropertyDirective));
...
initialization
  RegisterTest(TTestPropertyDirective.Suite);
{$ENDIF}
end.
